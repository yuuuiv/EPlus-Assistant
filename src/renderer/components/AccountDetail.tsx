...
export function AccountDetail(props: AccountDetailProps) {
  ...
  return (
    <section className="panel-card account-detail" aria-label="账号详情">
      <div className="panel-head"><h2>{props.account.label || props.account.eplusEmail}</h2><button type="button" className="icon-button" onClick={props.onClose}>关闭详情</button></div>
